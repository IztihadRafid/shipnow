...
const shipmentData = [
  {
    ...
    status: "In Transit",
    statusStyle: "bg-gray-5 text-gray-1",
    date: "Mar 20, 2035",
  },
  {
    id: "#SH9182635",
    ...
    statusStyle: "bg-purple-1/10 text-purple-1",
    date: "Mar 19, 2035",
  },
  {
    id: "#SH9037821",
...
export default function Shipmenttable() {
  return (
    <div className="bg-gray-3 rounded-xl p-4 xl:w-[858px] md:w-full">
      <div className="flex justify-between items-center bg-white h-[50px] rounded-lg p-2">
        ...
        <div className="flex justify-between items-center  text-gray-1 gap-3 ">
          <div className="flex items-center md:w-[290px] h-10 bg-gray-5 gap-1.5 rounded-lg p-2.5">
            <Search size={16} className="text-gray-2" />
            <input
              type="text"
              placeholder="Search shpipment"
              className="md:block hidden rounded-lg w-full bg-transparent outline-none text-sm text-gray-1"
            />
          </div>

          <button className="hidden md:block items-center bg-gray-5 text-gray-1 rounded-lg py-2.5 px-4">
            <SquareMenu size={16} />
          </button>
      ...
      <div className="overflow-x-auto">
        ...
        <tbody>
          {shipmentData.map((shipment) => (
            <tr
              key={shipment.id}
              className="border-b border-gray-1/10 last:border-0"
            >
              ...
              <td className="py-3 px-3 text-[12px] text-gray-1">
                {shipment.carrier}
              </td>
              <td className="py-3 px-3 text-[12px] text-gray-1">
                {shipment.route}
